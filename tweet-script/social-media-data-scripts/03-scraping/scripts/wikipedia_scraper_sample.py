...
# open the web site
urls = ["https://www.talabat.com/kuwait/aldahyia-juice"]
...
def scrapeContent(url):
    ...
    content = soup.find('div', class_='col-xs-16 p-t-md')
    all_groupings = content.find_all('div' , class_= "col-xs-8 col-sm-11 text-727272")
